...
public class VuelosController {
	...
	// http://localhost:8080/vuelos {"empresa": "AirlineX","fechaVuelo": "2024-07-01","precio": 350.0,"plazasDisponibles": 150}
	@PostMapping(value = "vuelos", consumes = MediaType.APPLICATION_JSON_VALUE)
	public void crearVuelo(@RequestBody Vuelo vuelo) {
	    service.crear(vuelo);
	}

	// http://localhost:8080/vuelos {"idVuelo": 1,"empresa": "AirlineY","fechaVuelo": "2024-07-05","precio": 400.0,"plazasDisponibles": 120}
	...
	// http://localhost:8080/vuelos/disponibles/100
	...
	// http://localhost:8080/vuelos/1/120
